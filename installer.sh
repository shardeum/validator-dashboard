...
git clone -b water https://github.com/shardeum/validator-dashboard.git ${NODEHOME} || { echo "Error: Permission denied. Exiting script."; exit 1; }
cd ${NODEHOME}
chmod a+x ./*.sh
...
NEXT_EXPLORER_URL=https://explorer-waternet.shardeum.org
EOL
