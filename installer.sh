...
RPC_SERVER_URL="http://35.229.156.94:8000"
...
git clone -b new-gui https://github.com/shardeum/validator-dashboard.git ${NODEHOME} || { echo "Error: Permission denied. Exiting script."; exit 1; }
cd ${NODEHOME}
chmod a+x ./*.sh
