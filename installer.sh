...
RPC_SERVER_URL="http://34.173.144.61:8080"
...
git clone -b dev-beta-1.11 https://gitlab.com/shardeum/validator/dashboard.git ${NODEHOME} || { echo "Error: Permission denied. Exiting script."; exit 1; }
cd ${NODEHOME}
chmod a+x ./*.sh
...
EXT_IP=${EXTERNALIP}
INT_IP=${INTERNALIP}
EXISTING_ARCHIVERS=[{\"ip\":\"198.58.115.4\",\"port\":4000,\"publicKey\":\"7af699dd711074eb96a8d1103e32b589e511613ebb0c6a789a9e8791b2b05f34\"},{\"ip\":\"52.59.212.239\",\"port\":4000,\"publicKey\":\"2db7c949632d26b87d7e7a5a4ad41c306f63ee972655121a37c5e4f52b00a542\"}]
