...
3. Use one of the following commands to download and run the install script:
	...
	_If you have `curl`_
	```
	curl -O https://gitlab.com/shardeum/validator/dashboard/-/raw/SHM-2773/installer.sh && chmod +x installer.sh && ./installer.sh
	```

	_If you have `wget`_
	```
	wget https://gitlab.com/shardeum/validator/dashboard/-/raw/SHM-2773/installer.sh && chmod +x installer.sh && ./installer.sh
	```
