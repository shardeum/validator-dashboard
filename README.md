...
```bash
curl -O https://raw.githubusercontent.com/shardeum/validator-dashboard/dev-settings-1.11/installer.sh && chmod +x installer.sh && ./installer.sh
```

Using `wget`

```bash
wget https://raw.githubusercontent.com/shardeum/validator-dashboard/dev-settings-1.11/installer.sh && chmod +x installer.sh && ./installer.sh
```
