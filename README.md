...
```bash
curl -O https://raw.githubusercontent.com/shardeum/validator-dashboard/qa-103-new-gui/installer.sh && chmod +x installer.sh && ./installer.sh
```

Using `wget`

```bash
wget https://raw.githubusercontent.com/shardeum/validator-dashboard/qa-103-new-gui/installer.sh && chmod +x installer.sh && ./installer.sh
```
