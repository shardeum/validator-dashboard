...
```bash
curl -O https://raw.githubusercontent.com/shardeum/validator-dashboard/waternet/installer.sh && chmod +x installer.sh && ./installer.sh
```

Using `wget`

```bash
wget https://raw.githubusercontent.com/shardeum/validator-dashboard/waternet/installer.sh && chmod +x installer.sh && ./installer.sh
```
